...
type CronJobProfileSpec struct {
	...
	// foo is an example field of CronJobProfile. Edit cronjobprofile_types.go to remove/update
	// +optional
...
type CronJobProfileStatus struct {
	...
	// conditions represent the current state of the CronJobProfile resource.
